...
<body>
    ...
    <!-- {{-- Sidebar panel --}} -->
    <?php include('./includes/sidebar-panel.php'); ?>
            ...
            <div class="background-service row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="service-one-inner one">
                        <div class="thumbnail">
                            <img src="./assets/images/service/icon/01.svg" alt="{{ config('app.name') }}">
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="service-one-inner two">
                        <div class="thumbnail">
                            <img src="./assets/images/service/icon/02.svg" alt="{{ route('our-services') }}">
                        </div>
                        <div class="service-details">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="service-one-inner three">
                        <div class="thumbnail">
                            <img src="./assets/images/service/icon/03.svg" alt="{{ route('our-services') }}">
                        </div>
                        <div class="service-details">
                            <a href="service-details.html">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="service-one-inner four">
                        <div class="thumbnail">
                            <img src="./assets/images/service/icon/04.svg" alt="{{ route('our-services') }}">
                        </div>
                        <div class="service-details">
                            <a href="service-details.html">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="service-one-inner five">
                        <div class="thumbnail">
                            <img src="./assets/images/service/icon/05.svg" alt="{{ route('our-services') }}">
                        </div>
                        <div class="service-details">
                            <a href="service-details.html">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="service-one-inner six">
                        <div class="thumbnail">
                            <img src="./assets/images/service/icon/06.svg" alt="{{ route('our-services') }}">
                        </div>
                        <div class="service-details">
                            <a href="service-details.html">
