        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-xl-block d-none">
                    <div class="left">
                        <div class="mail">
                            <a href="mailto:nahashonmbuci@gmail.com"><i class="fal fa-envelope"></i> support@digitalcloudbytes.com</a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-4">
                    <div class="thumbnail">
                        <a href="index.php">
                            <img src="./assets/images/logo/placeholder-logo.png" alt="{{ config('app.name') }}">
                        </a>
                    </div>
                </div>
